...
export default () => {
  ...
  return (
    <>
      <Box background='bg-primary' py={50} px={10} align='center'>
        <Box direction='column' staccSpace={38} maxWidth={900}>
          ...
          {websites.error ? (
            ...
            <Box staccSpace={20}>
              <Text color='fg-muted'>
                Welcome, {user.displayName}! You don't have any websites with
                analytics setup... yet. It's as easy as one click to get
                started.
              </Text>
      ...
      <Modal
        title='New website'
        visible={showNewWebsiteDialog}
        setVisible={setShowNewWebsiteDialog}
        controls={
          <Button
            variant='callout'
            color='alternate'
      ...
      >
        ...
        <Input
          ...
          onChange={(event) => setNewWebsiteDomain(event.target.value)}
        />
      </Modal>
    </>
  )
